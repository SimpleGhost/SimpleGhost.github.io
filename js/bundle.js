...
function cards() {
    class MenuCard {
        constructor(src, alt, title, descr, price, parentSelector, ...classes) {
            ...
            this.alt = alt;
            this.title = title;
            this.descr = descr;     // @01_devil_000 /@alexandra_romanova
            this.price = price;
...
function forms(formSelector, modalTimerId) {
    ...
    const message = {
        ...
        failure: 'Что-то сломалось, иди гуляй пока что'
    };
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__.default)('.timer', '2020-11-25');
